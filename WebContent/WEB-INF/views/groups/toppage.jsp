        ...
        <table id = "task_list">
            <tbody>
                <c:forEach var="show" items = "${shows}">
                    <tr>
                     <td><c:out value="${show.task.title}"/></td>
                     <td><fmt:formatDate value="${show.task.deadline}" pattern="yyyy/MM/dd HH:mm" /></td>
                     <td><a href="<c:url value='/tasks/show?id=${show.task.id}'/>">詳細</a></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
